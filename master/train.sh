...
# python train.py large_data_15.pt checkpoints/experiment_new.pt models/experiment_new.pt 300 #Baseline for measuring difficulty and sorting based on loss
...
python train.py large_data_15.pt checkpoints/experiment_large.pt models/experiment_new.pt 100 # Baseline with 100 epochs for comparison